...
export const metadata: Metadata = {
  ...
  description: 'Review images with pinned comments, replies and approval. Upload visual deliverables and collect client feedback in one simple link.',
...
export default function ImageReviewToolPage() {
  return (
    <main>
      <HeroSection eyebrow="Image review tool" title="Review images with comments in context." text="Upload images, screenshots or visual deliverables and collect clear feedback without sending files back and forth." primary="Upload image for review" />
      ...
      <CardGrid title="How it works" cards={[
        { title: 'Upload image', text: 'Add the visual deliverable for review.' },
      ...
      <CardGrid title="Use cases" cards={['Exported design files', 'Screenshots', 'Creative previews', 'Visual deliverables', 'Banners', 'UI screens', 'Campaign graphics'].map((title) => ({ title, text: 'Collect visual feedback in context.' }))} />
