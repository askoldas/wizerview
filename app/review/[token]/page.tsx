...
export default async function ReviewPage({ params, searchParams }: ReviewPageProps) {
  const previewAsClient = searchParams?.preview === 'client';
  ...
  if (access?.mode === 'creator' && access.reviewId && !previewAsClient) redirect(`/reviews/${access.reviewId}`);
  ...
  if (user && (access.mode === 'authenticated_standalone' || (access.mode === 'creator' && previewAsClient))) {
